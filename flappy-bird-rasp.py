...
# ==========================================
# 3. KAMERA PICAMERA2 (ZŁĄCZE CSI / IMX477)
# ==========================================
picam2 = Picamera2()
...
print(
    "Gra uruchomiona! Klaśnij, aby skoczyć. Klawisz 'R' resetuje, 'Q' wyłącza."
)

while True:
    # Pobranie klatki wprost z sensora CSI jako tablica NumPy BGR
    frame = picam2.capture_array()

    # Lustrzane odbicie kamery
